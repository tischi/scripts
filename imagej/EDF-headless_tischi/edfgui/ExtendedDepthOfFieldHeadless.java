...
public class ExtendedDepthOfFieldHeadless extends ExtendedDepthOfField {
	
	
	public ExtendedDepthOfFieldHeadless (ImagePlus imp, Parameters parameters) {
		super(imp, parameters);
	}
	 ...
	 */
	public ImagePlus processHeadless() {
