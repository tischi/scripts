...
fileIDs = ('.jpg','.jpeg') # enter unique string for the files you want to process
method = "scale" # contrast   # select method: scale OR contrast
...
def run():
  ...
  for root, directories, filenames in os.walk(srcDir):
    for filename in filenames:
      ...
      if not any(filename.endswith(x) for x in fileIDs):
        continue
