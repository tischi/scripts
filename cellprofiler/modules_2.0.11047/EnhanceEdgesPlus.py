'''<b>Enhance Edges Plus</b> enhances or identifies edges in an image, which can improve object
identification or other downstream image processing. In addition to the EnhanceEdges module it also contains a gaussian variance filter.
<hr>
...
#
#
# modified by Christian Tischer: tischitischer@gmail.com
#
#
...
from cellprofiler.cpmath.filter import laplacian_of_gaussian, variance_transform
...
class EnhanceEdgesPlus(cpm.CPModule):

    module_name = "EnhanceEdgesPlus"
    ...
    def create_settings(self):
        ...
        self.method = cps.Choice(
            ...
            [M_SOBEL, M_PREWITT, M_ROBERTS, M_LOG, M_CANNY, M_VARIANCE], doc = '''
            ...
            <li><i>%(M_VARIANCE)s:</i> Finds edges by computing the local variance in the gray values.</li>
            </ul>'''%globals())
    ...
    def visible_settings(self):
        ...
        if self.method in (M_LOG, M_CANNY, M_VARIANCE):
