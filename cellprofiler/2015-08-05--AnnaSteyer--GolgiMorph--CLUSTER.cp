...
LoadImages:[module_num:1|svn_version:\'11031\'|variable_revision_number:11|show_window:False|notes:\x5B\'one should add a background subtraction before measuring the total and diffuse golgi signal\'\x5D]
    File type to be loaded:individual images
    File selection method:Text-Exact match
    Number of images in each group?:3
    Type the text that the excluded images have in common:Do not use
    Analyze all subfolders within the selected folder?:All
    Input image file location:Elsewhere...\x7C/g/almfscreen/steyer/Schwab_Steyer_Golgi_plate_batch1_03
    ...
    Regular expression that finds metadata in the file name:^(?P<plate>.*)--.*--.*--W(?P<wellNum>.*)--P(?P<posNum>.*)--.*--.*--.*.tif
    Type the regular expression that finds metadata in the subfolder path:(?P<rootPath>.*)\x5B\\\\/\x5DW.*--(?P<siRNA>.*)--(?P<gene>.*)\x5B\\\\/\x5D.*$
    Channel count:1
...
Morph:[module_num:3|svn_version:\'11025\'|variable_revision_number:2|show_window:False|notes:\x5B\'SmallTH = TH(LargeTH)\'\x5D]
...
ImageMath:[module_num:5|svn_version:\'11025\'|variable_revision_number:3|show_window:False|notes:\x5B\'Blobs = LargeTH - SmallTH\', \'\', \'Blobs + Dots + Lines = (LargeTH - SmallTH) + (SmallTH - Lines) + Lines = LargeTH\'\x5D]
    Operation:Subtract
...
ImageMath:[module_num:6|svn_version:\'11025\'|variable_revision_number:3|show_window:False|notes:\x5B\'Dots = SmallTH - Lines\'\x5D]
    Operation:Subtract
    Raise the power of the result by:1
    Multiply the result by:1
    Add to result:0
...
IdentifyPrimaryObjects:[module_num:9|svn_version:\'11047\'|variable_revision_number:8|show_window:False|notes:\x5B\x5D]
...
IdentifySecondaryObjects:[module_num:10|svn_version:\'11025\'|variable_revision_number:7|show_window:False|notes:\x5B\x5D]
...
FilterObjects:[module_num:13|svn_version:\'11025\'|variable_revision_number:5|show_window:False|notes:\x5B\x5D]
...
Crop:[module_num:14|svn_version:\'11025\'|variable_revision_number:2|show_window:False|notes:\x5B\x5D]
    Select the input image:GolgiTophatLarge
...
MaskImage:[module_num:16|svn_version:\'11025\'|variable_revision_number:3|show_window:False|notes:\x5B\x5D]
...
MeasureObjectIntensity:[module_num:19|svn_version:\'11025\'|variable_revision_number:3|show_window:False|notes:\x5B\x5D]
    Hidden:5
    Select an image to measure:Golgi
...
RescaleIntensity:[module_num:25|svn_version:\'6746\'|variable_revision_number:2|show_window:False|notes:\x5B\x5D]
    Select the input image:Golgi
...
RescaleIntensity:[module_num:26|svn_version:\'6746\'|variable_revision_number:2|show_window:False|notes:\x5B\x5D]
    Select the input image:Dna
...
GrayToColor:[module_num:27|svn_version:\'11025\'|variable_revision_number:2|show_window:False|notes:\x5B\x5D]
...
SaveImages:[module_num:29|svn_version:\'11042\'|variable_revision_number:7|show_window:False|notes:\x5B\x5D]
    ...
    Enter single file name:\\g<plate>--\\g<siRNA>--\\g<gene>--\\g<wellNum>--\\g<posNum>--overlay
...
SaveImages:[module_num:30|svn_version:\'11042\'|variable_revision_number:7|show_window:True|notes:\x5B\x5D]
    Select the type of image to save:Image
    ...
    Select method for constructing file names:Single name
    Select image name for file prefix:Dna
    Enter single file name:\\g<plate>--\\g<siRNA>--\\g<gene>--\\g<wellNum>--\\g<posNum>--golgiRS
    Do you want to add a suffix to the image file name?:Yes
    Text to append to the image name:--seg
    Select file format to use:png
    Output file location:Elsewhere...\x7C\\g<rootPath>--cp/images
...
MeasureImageQuality:[module_num:31|svn_version:\'11045\'|variable_revision_number:4|show_window:False|notes:\x5B\x5D]
...
RelateObjects:[module_num:32|svn_version:\'11025\'|variable_revision_number:2|show_window:False|notes:\x5B\x5D]
...
RelateObjects:[module_num:33|svn_version:\'11025\'|variable_revision_number:2|show_window:False|notes:\x5B\x5D]
...
ExportToSpreadsheet:[module_num:35|svn_version:\'11042\'|variable_revision_number:7|show_window:False|notes:\x5B\x5D]
    ...
    Press button to select measurements to export:Image\x7CCount_Nuclei,Image\x7CImageQuality_PowerLogLogSlope_Dna,Image\x7CFileName_Overlay,Image\x7CFileName_Dna,Image\x7CFileName_Golgi,Image\x7CPathName_Overlay,Image\x7CPathName_Dna,Image\x7CPathName_Golgi,Image\x7CMetadata_posNum,Image\x7CMetadata_plate,Image\x7CMetadata_rootPath,Image\x7CMetadata_wellNum,Image\x7CMetadata_gene,Image\x7CMetadata_siRNA,Nuclei\x7CAreaShape_Area,Cells\x7CIntensity_IntegratedIntensity_GolgiLinesMasked,Cells\x7CIntensity_IntegratedIntensity_GolgiDotsMasked,Cells\x7CIntensity_IntegratedIntensity_GolgiDiffuse,Cells\x7CIntensity_IntegratedIntensity_Golgi,Cells\x7CIntensity_IntegratedIntensity_GolgiBlobsMasked,Cells\x7CChildren_Nuclei_Count,Cells\x7CChildren_MaxGolgi_Count,Cells\x7CChildren_Golgi_Count,Cells\x7CMean_Nuclei_Intensity_IntegratedIntensity_DnaTophat,Cells\x7CMean_Nuclei_Intensity_IntegratedIntensity_Dna,Cells\x7CMean_Nuclei_AreaShape_FormFactor,Cells\x7CMean_Nuclei_AreaShape_Area,Cells\x7CMean_MaxGolgi_AreaShape_FormFactor,Cells\x7CMean_MaxGolgi_AreaShape_Area,Cells\x7CMean_MaxGolgi_AreaShape_Compactness,Cells\x7CMean_Golgi_AreaShape_Area
    Data to export:Image
    Combine these object measurements with those of the previous object?:No
    File name:\\g<plate>--W\\g<wellNum>--P\\g<posNum>--image.csv
    Use the object name for the file name?:No
    Data to export:Cells
    Combine these object measurements with those of the previous object?:No
    File name:\\g<plate>--W\\g<wellNum>--P\\g<posNum>--objects.csv
    Use the object name for the file name?:No
